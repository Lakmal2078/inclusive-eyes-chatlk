...
export async function getChatParticipants(db, chatId) {
  const result = await db.prepare(`SELECT u.id, u.username, u.phone, u.display_name, u.avatar_url, u.bio, u.language, u.is_online, u.last_seen, u.is_verified, cp.role, cp.joined_at, cp.last_read_message_id
